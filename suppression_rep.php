...
$titre = "Suppression d'une représentation";
include('entete.php');
...
if (!isset($_POST['numS'])) {
    ...
    if (!$ok) {
        ...
        if (!$res) {
            ...
            echo "<p class=\"erreur\"><b>Aucune representation dans la base de donnée</b></p>";
        } else {

            // on affiche le formulaire de sélection
            echo '
                    <form action="suppression_rep.php" method="post">
    ...
    if (!$ok) {
        ...
        if (!$res) {
            ...
            // on affiche le formulaire de sélection
            echo '
                    <form action="suppression_rep_action.php" method="post">
